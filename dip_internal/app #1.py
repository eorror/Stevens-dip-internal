...
class fw(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.cup = tk.PhotoImage(file="images/flatwhite.png")
...
class moc(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.cup = tk.PhotoImage(file="images/mocha.png")
        labelcup = tk.Label(self, image = self.cup, background="#815940")
        labelcup.pack()
        labelcup.place(x=62, y=100)
...
class lat(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.cup = tk.PhotoImage(file="images/lat.png")
        labelcup = tk.Label(self, image = self.cup, background="#815940")
        labelcup.pack()
        labelcup.place(x=62, y=100)
...
class cap(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.cup = tk.PhotoImage(file="images/capp.png")
        labelcup = tk.Label(self, image = self.cup, background="#815940")
        labelcup.pack()
        labelcup.place(x=62, y=100)
